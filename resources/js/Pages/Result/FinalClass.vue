    ...
    <app-layout :pageTitle="`ক্লাস সমুহ`">
        ...
        <div class="grid gap-2 md:grid-cols-2 md:gap-4">
            <Link
                ...
                :key="classes.id"
                :href="
                    route('results.final.subjects', [classes.id]) +
                    '?session=' +
            ...
            >
                ...
                <div class="shrink grow">
                    ...
                    <div class="flex items-center gap-1 flex-wrap">
                        <span class="text-gray-600"> পরীক্ষা: </span>
                        <span
                            v-for="exam in classes.exams"
                            :key="exam.id"
                            class="font-bold text-sm text-gray-800 bg-gray-100 px-1.5 py-0.5 rounded-lg"
                        >
