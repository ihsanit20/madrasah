    ...
    <app-layout pageTitle="শিক্ষক/স্টাফ">
        ...
        <div class="w-full grid gap-2 md:grid-cols-2 md:gap-4 lg:grid-cols-3">
            ...
            >
                ...
                >
                    <div
                        class="flex flex-col gap-2 w-12 shrink-0 grow-0 items-center justify-center text-2xl font-bold text-brand-800 md:text-4xl"
                    >
                        <AvatarView
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-300 dark:peer-focus:ring-brand-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-brand-600"></div>
                        </label>

                    </div>
                    <div class="shrink grow">
                        <div class="text-md font-bold text-brand-600 md:text-2xl">
                            <Link
                        ...
                        >
                            ...
                            <div class="flex items-center gap-2">
                                <Link
                                    ...
                                    class="rounded bg-brand-100 px-3 py-0.5 text-sm text-brand-600"
                                >
                                    বেতন দিন
                                </Link>
                            </div>
