...
class Salary extends Model
{
    ...
    protected static $purposes =  [
        ...
        33 => "মাসিক বেতন : জানুয়ারি ২০২৫",
        34 => "মাসিক বেতন : ফেব্রুয়ারি ২০২৫",
        35 => "মাসিক বেতন : মার্চ ২০২৫",
        36 => "মাসিক বেতন : এপ্রিল ২০২৫",
        37 => "মাসিক বেতন : মে ২০২৫",
        38 => "মাসিক বেতন : জুন ২০২৫",
        39 => "মাসিক বেতন : জুলাই ২০২৫",
        40 => "মাসিক বেতন : আগস্ট ২০২৫",
        41 => "মাসিক বেতন : সেপ্টেম্বর ২০২৫",
        42 => "মাসিক বেতন : অক্টোবর ২০২৫",
        43 => "মাসিক বেতন : নভেম্বর ২০২৫",
        44 => "মাসিক বেতন : ডিসেম্বর ২০২৫",
    ];
