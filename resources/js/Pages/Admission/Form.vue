...
export default {
    ...
    created() {
        ...
        if (this.moduleAction == "update") {
            this.form.father_info = this.data.admission.fatherInfo;
            this.form.mother_info = this.data.admission.motherInfo;
            this.form.guardian_info = this.data.admission.guardianInfo;

            this.form.present_address.address =
                this.data.admission.presentAddress.value;
            this.form.present_address.area =
                this.data.admission.presentAddress.areaId;
            this.form.present_address.district =
                this.data.admission.presentAddress.area.districtId;
            this.form.present_address.division =
                this.data.admission.presentAddress.area.district.divisionId;

            this.form.permanent_address.address =
                this.data.admission.permanentAddress.value;
            this.form.permanent_address.area =
                this.data.admission.permanentAddress.areaId;
            this.form.permanent_address.district =
                this.data.admission.permanentAddress.area.districtId;
            this.form.permanent_address.division =
                this.data.admission.permanentAddress.area.district.divisionId;
        }
    },
    data() {
        return {
            ...
            form: this.$inertia.form({
                name: this.data.admission.name,
                date_of_birth: this.data.admission.dateOfBirth,
                birth_certificate: this.data.admission.birthCertificate,
                gender:
                    this.moduleAction == "update"
                        ? this.data.admission.gender
                        : 0,
                father_info: {
                    name: "",
                    phone: "",
                ...
                guardian_type:
                    this.moduleAction == "update"
                        ? this.data.admission.guardianType
                        : 0,
                guardian_info: {
                    name: "",
                    phone: "",
                ...
                is_same_address:
                    this.moduleAction == "update"
                        ? this.data.admission.isSameAddress
                        : 0,
                present_address: {
                    division: "",
                    district: "",
